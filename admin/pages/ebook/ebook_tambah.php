...
<head>
  ...
  <title>Digital Library | Add E-Book</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="kategori.php">E-Book</a></li>
			  <li class="breadcrumb-item active">Add E-Book</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
		  ...
		  <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo $url;?>control/ebook/con_ebook_tambah.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputFile">Code</label>
                    <input type="text" class="form-control" id="kode" name="kode" placeholder="E-Book Code" required>
                  </div>
			      <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <textarea rows="4" cols="50" id="deskripsi" name="deskripsi" ></textarea>
                  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tahun" name="tahun" placeholder="Year">
                  </div>
				  ...
				  <div class="form-group">
						<label for="exampleInputFile">Upload E-Book</label><br/>
                        <input type="file" name="file_upload" required>
                  </div>
                  <div class="form-group">
						<label for="exampleInputFile">Pict. Cover</label><br/>
