...
<head>
  ...
  <title>Digital Library | Publisher</title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
			  <a class='btn btn-primary btn-xs' title='Add Data' href='penerbit_tambah.php'><font size='4'>Add Data</font></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$no=1;
				$sql = "select * from penerbit order by nama";
			    ...
			    ?>
					<tr>
					  ...
					  <td><img src="<?php echo $url;?>images/penerbit/<?php echo $row['gambar']; ?>" width='50px' height='50px'</td>
					  <td>
						<center>
							<a class='btn btn-success btn-xs' title='Edit Data' 
								href='<?php echo $url;?>admin/pages/penerbit/penerbit_ubah.php?id=<?php echo $row["id"]; ?>'>
							...
							<a class='btn btn-danger btn-xs' title='Delete Data' href='<?php echo $url;?>control/penerbit/con_penerbit_hapus.php?id=<?php echo $row["id"]; ?>' onclick="return confirm('Apa anda yakin untuk hapus Data ini?')"><i class="nav-icon fas fa-times"></i></a>
						 </center>
					  </td>
					</tr>
				<?php
