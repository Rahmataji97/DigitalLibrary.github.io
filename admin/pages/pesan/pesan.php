...
<head>
  ...
  <title>Digital Library | Message</title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
			  <a class='btn btn-primary btn-xs' title='Add Data' href=''><font size='4'>Message</font></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$no=1;
				$sql = "select * from pesan order by id";
			    ...
			    ?>
					<tr>
					  ...
					  <td><?php echo substr($row['pesan'],0,40)."..."; ?></td>
					  <td>
						<center>
							<a class='btn btn-success btn-xs' title='View Data' 
								href='<?php echo $url;?>admin/pages/pesan/pesan_view.php?id=<?php echo $row["id"]; ?>'>
								<i class="nav-icon fas fa-check"></i></a>
							<a class='btn btn-danger btn-xs' title='Delete Data' href='<?php echo $url;?>control/pesan.php?idpesan=<?php echo $row["id"]; ?>&action=0' onclick="return confirm('Apa anda yakin untuk hapus pesan ini?')"><i class="nav-icon fas fa-times"></i></a>
						 </center>
					  </td>
					</tr>
				<?php
