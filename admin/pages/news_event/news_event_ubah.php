...
<head>
  ...
  <title>Digital Library | Edit Event</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="news_event.php">Event</a></li>
      ...
      <div class="container-fluid">
        <div class="row">
		  ...
		  <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo $url;?>control/news_event/con_news_event_ubah.php" enctype="multipart/form-data">
                <div class="card-body">
				  <?php
					$id 	= $_GET['id'];
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $row['nama']; ?>" placeholder="Title" required>
                  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tanggal1" name="tanggal1" value="<?php  echo $row['tanggal1']; ?>" required>
                  </div>
				  <div class="form-group">
                    <label for="exampleInputFile">To Date</label>
                    <input type="date" class="form-control" id="tanggal2" name="tanggal2" value="<?php  echo $row['tanggal2']; ?>" required>
                  </div>
				  <div class="form-group">
                    <label for="exampleInputFile">From Time</label>
                    <input type="time" class="form-control" id="jam1" name="jam1" value="<?php  echo $row['jam1']; ?>" required>
                  </div>
				  <div class="form-group">
                    <label for="exampleInputFile">To Time</label>
                    <input type="time" class="form-control" id="jam2" name="jam2" value="<?php  echo $row['jam2']; ?>" required>
                  </div>
				  <div class="form-group">
                    <input type="hidden" class="form-control" id="gambar_old" name="gambar_old" value="<?php  echo $row['gambar']; ?>" required>
                  </div>
                  <div class="form-group">
				  ...
				  <div class="form-group">
					<img src="<?php echo $url; ?>images/news_event/<?php echo $row['gambar']; ?>" width="250px" height="250px" /> 
				  </div>
					<?php } ?>
                </div>
                <!-- /.card-body -->
			...
			<div class="card-body"> 
				<a title='Add Data' href='news_event.php'><button class="btn btn-danger">Back</button>
			</div>
		  </div>
		</div>
	  </div>
