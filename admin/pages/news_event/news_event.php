...
<head>
  ...
  <title>Digital Library | News & Events</title>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php 
				$no=1;
				$sql = "select * from news_event order by tanggal1, jam1";
			    ...
			    ?>
					<tr>
					  ...
					  <td><?php echo date('d/m/Y', strtotime($row['tanggal1'])).'-'.date('d/m/Y', strtotime($row['tanggal2'])); ?></td>
					  <td><?php echo date('G:i:s', strtotime($row['jam1'])).'-'.date('G:i:s', strtotime($row['jam2'])); ?></td>
					  <td><?php echo $row['deskripsi']; ?></td>
					  <td><img src="<?php echo $url;?>images/news_event/<?php echo $row['gambar']; ?>" width='50px' height='50px'</td>
					  <td>
						<center>
							<a class='btn btn-success btn-xs' title='Edit Data' 
								href='<?php echo $url;?>admin/pages/news_event/news_event_ubah.php?id=<?php echo $row["id"]; ?>'>
								<i class="nav-icon fas fa-check"></i></a>
							<a class='btn btn-danger btn-xs' title='Delete Data' href='<?php echo $url;?>control/news_event/con_news_event_hapus.php?id=<?php echo $row["id"]; ?>' onclick="return confirm('Apa anda yakin untuk hapus Data ini?')"><i class="nav-icon fas fa-times"></i></a>
						 </center>
					  </td>
					</tr>
				<?php
