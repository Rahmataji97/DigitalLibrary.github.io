...
<head>
  ...
  <title>Digital Library | Add Sub Category</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="sub_kategori.php">Sub Category</a></li>
      ...
      <div class="container-fluid">
        <div class="row">
		  ...
		  <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo $url;?>control/sub_kategori/con_sub_kategori_tambah.php" enctype="multipart/form-data">
                <div class="card-body">
			...
			<div class="card-body"> 
				<a title='Add Data' href='sub_kategori.php'><button class="btn btn-danger">Back</button>
            </div>
		  </div>
		</div>
	  </div>
