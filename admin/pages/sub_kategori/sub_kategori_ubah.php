...
<head>
  ...
  <title>Digital Library | Edit Sub Category</title>
      ...
      <div class="container-fluid">
        <div class="row">
		  ...
		  <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo $url;?>control/sub_kategori/con_sub_kategori_ubah.php" enctype="multipart/form-data">
                <div class="card-body">
				  <?php
					$id 	= $_GET['id'];
				  ...
				  <div class="form-group">
					<img src="<?php echo $url; ?>images/sub_kategori/<?php echo $row['gambar']; ?>" width="250px" height="250px" /> 
				  </div>
					<?php } ?>
                </div>
                <!-- /.card-body -->
