...
<head>
  ...
  <title>Digital Library | Add Category</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="kategori.php">Category</a></li>
      ...
      <div class="container-fluid">
        <div class="row">
		  ...
		  <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo $url;?>control/kategori/con_kategori_tambah.php" enctype="multipart/form-data">
                <div class="card-body">
			...
			<div class="card-body"> 
				<a title='Add Data' href='kategori.php'><button class="btn btn-danger">Back</button>
			</div>
		  </div>
		</div>
	  </div>
