...
<head>
  ...
  <title>Digital Library | Edit Category</title>
      ...
      <div class="container-fluid">
        <div class="row">
		  ...
		  <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo $url;?>control/kategori/con_kategori_ubah.php" enctype="multipart/form-data">
                <div class="card-body">
				  <?php
					$id 	= $_GET['id'];
				  ...
				  <div class="form-group">
                    <input type="hidden" class="form-control" value="<?php echo $id; ?>" id="id_kategori" name="id_kategori">
                  </div>
                  <div class="form-group">
				  ...
				  <div class="form-group">
					<img src="<?php echo $url; ?>images/kategori/<?php echo $row['gambar']; ?>" width="250px" height="250px" /> 
				  </div>
					<?php } ?>
                </div>
                <!-- /.card-body -->
