...
<head>
  ...
  <title>UNAS Digital Library | User</title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
			  <a class='btn btn-primary btn-xs' title='Add Data' href='user_tambah.php'><font size='4'>Add Data</font></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
			    ...
			    ?>
					<tr>
					  ...
					  ?>
					  <td><img src="<?php echo $url;?>images/user/<?php echo $row['gambar']; ?>" width='50px' height='50px'</td>
					  <td>
						<center>
							<a class='btn btn-success btn-xs' title='Edit Data' 
								href='<?php echo $url;?>admin/pages/user/user_ubah.php?id=<?php echo $row["id"]; ?>'>
								<i class="nav-icon fas fa-check"></i></a>
							<a class='btn btn-danger btn-xs' title='Delete Data' href='<?php echo $url;?>control/user/con_user_hapus.php?id=<?php echo $row["id"]; ?>' onclick="return confirm('Apa anda yakin untuk hapus Data ini?')"><i class="nav-icon fas fa-times"></i></a>
						 </center>
					  </td>
					</tr>
				<?php
